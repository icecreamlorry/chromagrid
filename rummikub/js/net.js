// Rummikub networking — thin wrapper around the shared rooms layer.
// createNet binds GAME_SLUG (and the push `game` default) to the room helpers
// so callers in this game don't need to pass the slug explicitly. Rummikub
// rooms seat 2–4 players, so createRoom is called with maxPlayers = 4.
